...
def create_app():
    ...
    app.config['MYSQL_DATABASE_DB'] = 'spotipy'  # Change this to your DB name
    ...
    app.register_blueprint(artists, url_prefix='/art')
    app.register_blueprint(producers, url_prefix='/prod')
